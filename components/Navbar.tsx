    ...
    <nav className="bg-white shadow-md py-4 border-b border-gray-200">
      <div className=" container mx-auto flex justify-between items-center px-6 lg:px-8">
        ...
        <div className=" flex items-center space-x-4">
          <Link href={"/trips"} className="text-slate-900 hover:text-blue-600">
            My Trips
          </Link>
          <Link href={"/globe"} className="text-slate-900 hover:text-blue-600">
            {" "}
            Globe
          </Link>

          <button className="flex items-center justify-center bg-gray-800 text-white p-2 rounded-sm  hover:bg-gray-900 cursor-pointer">
            Sign In
            <svg
